...
exports.run = (client, message, args) => {
  ...
  let avatar = guild.channels.find('name', 'mod-log');
  if (!avatar) return message.reply('`mod-log` kanalını bulamıyorum.');
  ...
  return guild.channels.get(avatar.id).sendEmbed(embed);
